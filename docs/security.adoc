...
----
export ALICE_TOKEN=$(\
    curl -s -X POST https://{{ USER_ID }}{{ KEYCLOAK_PRE_URL }}/auth/realms/quarkus/protocol/openid-connect/token \
...
Injected issuer: ["https://{{ USER_ID }}{{ KEYCLOAK_PRE_URL }}/auth/realms/quarkus"]
...
[source,sh,role="copypaste"]
----
mvn quarkus:add-extension -Dextensions="oidc, keycloak-authorization" -f $CHE_PROJECTS_ROOT/quarkus-workshop-m1m2-labs
----
...
[source,sh,role="copypaste"]
----
mvn quarkus:remove-extension -Dextensions="smallrye-jwt" -f $CHE_PROJECTS_ROOT/quarkus-workshop-m1m2-labs
----
...
----
# OIDC config
quarkus.oidc.auth-server-url=https://{{ USER_ID }}{{ KEYCLOAK_PRE_URL }}/auth/realms/quarkus
...
content-length: 380
content-type: text/plain;charset=UTF-8
set-cookie: 2a1b392100b8b2cb3705c68f4ecbaf66=8392213f62a8f2a2ccc58851e9316cc7; path=/; HttpOnly
cache-control: private

confidential access for: jdoe with attributes:{configuration-metadata=io.quarkus.oidc.OidcConfigurationMetadata@46b1783a, io.quarkus.security.identity.AuthenticationRequestContext=io.quarkus.security.runtime.QuarkusIdentityProviderManagerImpl$1@7a5e12e6, tenant-id=Default, permissions=[Permission {id=99856673-24fa-431b-9e26-93e2113f69db, name=Confidential Resource, scopes=[]}]}
----
